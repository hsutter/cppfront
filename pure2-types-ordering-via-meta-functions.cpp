...
#line 1 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"

#line 2 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
class my_integer;
    

#line 7 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
class case_insensitive_string;
    

#line 12 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
class person_in_family_tree;
    

#line 17 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
class mystruct;
...
#line 4 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
...
#line 5 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
};

class case_insensitive_string {
    private: std::string v; // case insensitive
    public: case_insensitive_string(cpp2::impl::in<std::string> val);
#line 9 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
...
#line 10 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
};

class person_in_family_tree {
    private: int dummy_data; 
    public: person_in_family_tree(cpp2::impl::in<int> parents);
#line 14 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
...
#line 15 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
};
...
#line 19 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
};
...
requires (std::is_convertible_v<CPP2_TYPEOF(val_), std::add_const_t<int>&>) {
                                                             ...
                                                             return *this;}
mystruct::mystruct(){}
#line 21 "regression-tests/pure2-types-ordering-via-meta-functions.cpp2"
auto main() -> int{
    my_integer a {1}; 
    my_integer b {2}; 

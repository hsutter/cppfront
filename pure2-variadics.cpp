...
#line 1 "regression-tests/pure2-variadics.cpp2"

#line 3 "regression-tests/pure2-variadics.cpp2"
template<typename ...Ts> class x;
    

#line 10 "regression-tests/pure2-variadics.cpp2"
template<int ...Ts> class y;

#line 16 "regression-tests/pure2-variadics.cpp2"
template<typename ...UnnamedTypeParam1_1> class t0;
  

#line 21 "regression-tests/pure2-variadics.cpp2"
template<auto ...T> class t1;
  

#line 26 "regression-tests/pure2-variadics.cpp2"
...
#line 7 "regression-tests/pure2-variadics.cpp2"
};
...
#line 13 "regression-tests/pure2-variadics.cpp2"
};
...
#line 35 "regression-tests/pure2-variadics.cpp2"
template<typename ...Args> [[nodiscard]] auto all(Args const& ...args) -> bool;

#line 39 "regression-tests/pure2-variadics.cpp2"
...
#line 6 "regression-tests/pure2-variadics.cpp2"
    template <typename ...Ts> auto x<Ts...>::func() -> void{}

#line 12 "regression-tests/pure2-variadics.cpp2"
    template <int ...Ts> [[nodiscard]] auto y<Ts...>::func() -> decltype(auto) { return (0 + ... + Ts);  }

#line 17 "regression-tests/pure2-variadics.cpp2"
...
#line 22 "regression-tests/pure2-variadics.cpp2"
  template <auto ...T> template<int UnnamedTypeParam1_4> [[nodiscard]] auto t1<T...>::f() -> cpp2::i32 { return 0;  }

#line 27 "regression-tests/pure2-variadics.cpp2"
...
#line 30 "regression-tests/pure2-variadics.cpp2"
template<typename ...Args> auto left_fold_print(std::ostream& out, Args const& ...args) -> void{

...
#line 1 "regression-tests/mixed-is-as-value-with-variant.cpp2"
...
#line 5 "regression-tests/mixed-is-as-value-with-variant.cpp2"
auto test(auto&& v) -> void;

#line 40 "regression-tests/mixed-is-as-value-with-variant.cpp2"
using my_variant = std::variant<std::monostate,int,int,std::optional<int>,std::any,int*,std::unique_ptr<int>>;

[[nodiscard]] auto main() -> int;

#line 110 "regression-tests/mixed-is-as-value-with-variant.cpp2"
...
#line 42 "regression-tests/mixed-is-as-value-with-variant.cpp2"
[[nodiscard]] auto main() -> int{

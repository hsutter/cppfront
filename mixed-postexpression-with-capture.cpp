...
#line 1 "regression-tests/mixed-postexpression-with-capture.cpp2"
...
#line 8 "regression-tests/mixed-postexpression-with-capture.cpp2"
[[nodiscard]] auto main() -> int;

#line 14 "regression-tests/mixed-postexpression-with-capture.cpp2"
...
#line 23 "regression-tests/mixed-postexpression-with-capture.cpp2"
[[nodiscard]] auto make_string() -> make_string_ret;
struct make_strings_ret { std::string a; std::string b; };



#line 29 "regression-tests/mixed-postexpression-with-capture.cpp2"
[[nodiscard]] auto make_strings() -> make_strings_ret;
#line 38 "regression-tests/mixed-postexpression-with-capture.cpp2"
...
#line 16 "regression-tests/mixed-postexpression-with-capture.cpp2"
auto insert_at(cpp2::impl::in<int> where, cpp2::impl::in<int> val) -> void

#line 19 "regression-tests/mixed-postexpression-with-capture.cpp2"
{
...
#line 20 "regression-tests/mixed-postexpression-with-capture.cpp2"
...
#line 26 "regression-tests/mixed-postexpression-with-capture.cpp2"
    ret += " and ";
...
#line 35 "regression-tests/mixed-postexpression-with-capture.cpp2"
{
cpp2::finally_presuccess cpp2_finally_presuccess;
std::string a {"xyzzy"};
std::string b {"plugh"};
...
#line 30 "regression-tests/mixed-postexpression-with-capture.cpp2"
cpp2_finally_presuccess.run(); return  { std::move(a), std::move(b) }; 

#line 36 "regression-tests/mixed-postexpression-with-capture.cpp2"

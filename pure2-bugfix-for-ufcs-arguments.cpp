...
#line 1 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"

#line 7 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
class t;
  

#line 58 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
namespace ns {
...
#line 68 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
class B;
...
#line 55 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 71 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
};
...
#line 1 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
[[nodiscard]] auto print_res(cpp2::impl::in<cpp2::i32> x) -> cpp2::i32{
#line 2 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
  std::cout << x;
  if (x == 9) {std::cout << '\n'; }
  return x; 
}

#line 8 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
  [[nodiscard]] auto t::f() & -> cpp2::i32 { return print_res(0);  }
#line 9 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
  [[nodiscard]] auto t::f([[maybe_unused]] auto const& unnamed_param_2) & -> cpp2::i32 { return print_res(1);  }
#line 10 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
  template<typename UnnamedTypeParam1_1> [[nodiscard]] auto t::f() & -> cpp2::i32 { return print_res(2);  }
#line 11 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 12 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 15 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
[[nodiscard]] auto f([[maybe_unused]] cpp2::impl::in<t> unnamed_param_1) -> cpp2::i32 { return print_res(5);  }
#line 16 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 17 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 18 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 19 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 25 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 37 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
auto main() -> int{
...
#line 56 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
cpp2::i32 auto_19 {CPP2_UFCS_QUALIFIED_TEMPLATE_NONLOCAL((ns::t<0,0>::),f<0>)(0)}; 

namespace ns {

#line 60 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
...
#line 65 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"
  auto A::f() const& -> void{}

#line 70 "regression-tests/pure2-bugfix-for-ufcs-arguments.cpp2"

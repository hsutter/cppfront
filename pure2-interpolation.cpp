...
#line 1 "regression-tests/pure2-interpolation.cpp2"

#line 2 "regression-tests/pure2-interpolation.cpp2"
class item;
...
#line 3 "regression-tests/pure2-interpolation.cpp2"
    [[nodiscard]] auto item::name() const& -> std::string { return "Dog kennel";  }
#line 4 "regression-tests/pure2-interpolation.cpp2"
    [[nodiscard]] auto item::color() const& -> std::string { return "mauve";  }
#line 5 "regression-tests/pure2-interpolation.cpp2"
    [[nodiscard]] auto item::price() const& -> double { return 3.14;  }
#line 6 "regression-tests/pure2-interpolation.cpp2"
    [[nodiscard]] auto item::count() const& -> int { return 42;  }

#line 9 "regression-tests/pure2-interpolation.cpp2"
[[nodiscard]] auto main() -> int{
{
auto const& x{0};

#line 11 "regression-tests/pure2-interpolation.cpp2"
    {
...
#line 25 "regression-tests/pure2-interpolation.cpp2"
    {
...
#line 31 "regression-tests/pure2-interpolation.cpp2"

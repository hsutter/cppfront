...
#line 1 "regression-tests/pure2-types-inheritance.cpp2"

#line 2 "regression-tests/pure2-types-inheritance.cpp2"
class Human;
    

#line 6 "regression-tests/pure2-types-inheritance.cpp2"
namespace N {
    template<int I> class Machine;
        

#line 11 "regression-tests/pure2-types-inheritance.cpp2"
}
...
#line 4 "regression-tests/pure2-types-inheritance.cpp2"
};
...
#line 10 "regression-tests/pure2-types-inheritance.cpp2"
    };
}

struct Cyborg_name_as_base { std::string name; };
struct Cyborg_address_as_base { std::string address; };
#line 13 "regression-tests/pure2-types-inheritance.cpp2"
class Cyborg: public Cyborg_name_as_base, public Human, public Cyborg_address_as_base, public N::Machine<99> {

#line 19 "regression-tests/pure2-types-inheritance.cpp2"
    public: Cyborg(cpp2::impl::in<std::string> n);

#line 25 "regression-tests/pure2-types-inheritance.cpp2"
    public: auto speak() const -> void override;

#line 29 "regression-tests/pure2-types-inheritance.cpp2"
    public: auto work() const -> void override;

#line 33 "regression-tests/pure2-types-inheritance.cpp2"
    public: auto print() const& -> void;

#line 37 "regression-tests/pure2-types-inheritance.cpp2"
...
#line 39 "regression-tests/pure2-types-inheritance.cpp2"
};

auto make_speak(cpp2::impl::in<Human> h) -> void;

#line 46 "regression-tests/pure2-types-inheritance.cpp2"
auto do_work(cpp2::impl::in<N::Machine<99>> m) -> void;

#line 51 "regression-tests/pure2-types-inheritance.cpp2"
auto main() -> int;
...
#line 8 "regression-tests/pure2-types-inheritance.cpp2"
...
#line 22 "regression-tests/pure2-types-inheritance.cpp2"
...
#line 41 "regression-tests/pure2-types-inheritance.cpp2"
auto make_speak(cpp2::impl::in<Human> h) -> void{

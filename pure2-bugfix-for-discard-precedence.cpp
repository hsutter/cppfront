...
#line 1 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
class quantity;
#line 2 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
...
#line 3 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
...
#line 5 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
};
...
#line 3 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
  auto quantity::operator=(cpp2::impl::in<cpp2::i32> x) -> quantity&  { 
                                  number = x;
                                  return *this; }
#line 4 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
  [[nodiscard]] auto quantity::operator+(quantity const& that) & -> quantity { return quantity(number + that.number);  }

#line 7 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
auto main(int const argc_, char** argv_) -> int{
  auto const args = cpp2::make_args(argc_, argv_); 
#line 8 "regression-tests/pure2-bugfix-for-discard-precedence.cpp2"
  quantity x {1729}; 

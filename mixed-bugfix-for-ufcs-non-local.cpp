...
#line 1 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"

#line 9 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
namespace ns {

#line 39 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
class u;
  

#line 46 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
}
...
#line 21 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
...
#line 23 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
...
#line 25 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
auto g() -> void{
                     if (cpp2::cpp2_default.is_active() && !(CPP2_UFCS(f)(o)) ) { cpp2::cpp2_default.report_violation(""); }}

#line 27 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
[[nodiscard]] auto h() -> t<CPP2_UFCS_NONLOCAL(f)(o)> { return o;  }// Fails on Clang 12 (lambda in unevaluated context).

#line 40 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
...
#line 43 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
...
#line 48 "regression-tests/mixed-bugfix-for-ufcs-non-local.cpp2"
auto main() -> int{}

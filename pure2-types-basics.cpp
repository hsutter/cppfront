...
#line 1 "regression-tests/pure2-types-basics.cpp2"

#line 2 "regression-tests/pure2-types-basics.cpp2"
namespace N {

class myclass;

#line 64 "regression-tests/pure2-types-basics.cpp2"
}
...
#line 6 "regression-tests/pure2-types-basics.cpp2"
    public: auto operator=(cpp2::impl::in<int> x) -> myclass& ;

#line 13 "regression-tests/pure2-types-basics.cpp2"
    public: myclass(cpp2::impl::in<std::string> s);
#line 13 "regression-tests/pure2-types-basics.cpp2"
    public: auto operator=(cpp2::impl::in<std::string> s) -> myclass& ;

#line 20 "regression-tests/pure2-types-basics.cpp2"
    public: myclass(cpp2::impl::in<int> x, cpp2::impl::in<std::string> s);

#line 27 "regression-tests/pure2-types-basics.cpp2"
    public: explicit myclass();

#line 34 "regression-tests/pure2-types-basics.cpp2"
    public: auto print() const& -> void;

#line 38 "regression-tests/pure2-types-basics.cpp2"
    public: auto print() && -> void;

#line 42 "regression-tests/pure2-types-basics.cpp2"
    public: ~myclass() noexcept;

#line 46 "regression-tests/pure2-types-basics.cpp2"
    public: auto f(cpp2::impl::in<int> x) const& -> void;

#line 50 "regression-tests/pure2-types-basics.cpp2"
...
#line 55 "regression-tests/pure2-types-basics.cpp2"
    };
...
#line 62 "regression-tests/pure2-types-basics.cpp2"
};
...
#line 9 "regression-tests/pure2-types-basics.cpp2"
...
#line 9 "regression-tests/pure2-types-basics.cpp2"
        ...
        print();
        return *this;
#line 11 "regression-tests/pure2-types-basics.cpp2"
    }
...
#line 16 "regression-tests/pure2-types-basics.cpp2"
...
#line 16 "regression-tests/pure2-types-basics.cpp2"
        ...
        print();
        return *this;
#line 18 "regression-tests/pure2-types-basics.cpp2"
    }
...
#line 23 "regression-tests/pure2-types-basics.cpp2"
...
#line 30 "regression-tests/pure2-types-basics.cpp2"

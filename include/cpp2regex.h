...
#line 1194 "regex.h2"
    public: [[nodiscard]] auto parse_modifiers(cpp2::in<std::string> change_str, cpp2::out<std::string> modifier_change, bool& group_captures_have_numbers) & -> bool;
...
#line 1194 "regex.h2"
    template <typename Error_out> [[nodiscard]] auto regex_parser<Error_out>::parse_modifiers(cpp2::in<std::string> change_str, cpp2::out<std::string> modifier_change, bool& group_captures_have_numbers) & -> bool{

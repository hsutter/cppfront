...
#line 1 "regression-tests/pure2-last-use.cpp2"

#line 169 "regression-tests/pure2-last-use.cpp2"
class issue_857;
  

#line 257 "regression-tests/pure2-last-use.cpp2"
class issue_857_2;
  

#line 262 "regression-tests/pure2-last-use.cpp2"
class issue_857_3;
  

#line 266 "regression-tests/pure2-last-use.cpp2"
class issue_857_6;
  

#line 271 "regression-tests/pure2-last-use.cpp2"
class issue_857_4;
   

#line 331 "regression-tests/pure2-last-use.cpp2"
class issue_857_5;
  

#line 336 "regression-tests/pure2-last-use.cpp2"
class issue_857_7;
  

#line 342 "regression-tests/pure2-last-use.cpp2"
class issue_857_8;
  

#line 348 "regression-tests/pure2-last-use.cpp2"
class issue_857_9;
  

#line 365 "regression-tests/pure2-last-use.cpp2"
class issue_869_0;
...
#line 838 "regression-tests/pure2-last-use.cpp2"
class cpp2_union;
  

#line 846 "regression-tests/pure2-last-use.cpp2"
class my_string;
  

#line 905 "regression-tests/pure2-last-use.cpp2"
namespace captures {

#line 919 "regression-tests/pure2-last-use.cpp2"
class t;
  

#line 948 "regression-tests/pure2-last-use.cpp2"
}

#line 978 "regression-tests/pure2-last-use.cpp2"
class types;
...
#line 2 "regression-tests/pure2-last-use.cpp2"
...
#line 6 "regression-tests/pure2-last-use.cpp2"
[[nodiscard]] auto identity_copy(auto x) -> auto
CPP2_REQUIRES (std::copyable<decltype(x)>) ;
#line 7 "regression-tests/pure2-last-use.cpp2"
[[nodiscard]] auto identity_copy(auto&& x) -> auto
CPP2_REQUIRES (!(std::copyable<decltype(x)>)) ;

#line 9 "regression-tests/pure2-last-use.cpp2"
auto issue_313() -> void;

#line 73 "regression-tests/pure2-last-use.cpp2"
auto issue_313_1(std::unique_ptr<int> x) -> void;

auto issue_350() -> void;

#line 86 "regression-tests/pure2-last-use.cpp2"
/*
issue_440_0: () -> int = {
  i: int;
  if true {
...
#line 114 "regression-tests/pure2-last-use.cpp2"
auto issue_825() -> void;

#line 120 "regression-tests/pure2-last-use.cpp2"
auto issue_832() -> void;

#line 125 "regression-tests/pure2-last-use.cpp2"
[[nodiscard]] auto make_copy(auto x) -> auto;

auto issue_847_4(std::vector<int> v) -> void;

#line 133 "regression-tests/pure2-last-use.cpp2"
auto issue_847_0(std::vector<std::unique_ptr<int>> v) -> void;

#line 139 "regression-tests/pure2-last-use.cpp2"
...
#line 151 "regression-tests/pure2-last-use.cpp2"
auto issue_847_2(auto&& v) -> void;

#line 156 "regression-tests/pure2-last-use.cpp2"
...
#line 258 "regression-tests/pure2-last-use.cpp2"
                           // OK: No error about 'a' being unused.
#line 259 "regression-tests/pure2-last-use.cpp2"
};
...
#line 265 "regression-tests/pure2-last-use.cpp2"
};
class issue_857_6 {
  public: [[nodiscard]] auto f() && -> decltype(auto);
  public: std::add_lvalue_reference_t<int> i {gi}; 
...
#line 269 "regression-tests/pure2-last-use.cpp2"
};
...
//   /*i3*/ }
//   }
#line 329 "regression-tests/pure2-last-use.cpp2"
};
...
#line 334 "regression-tests/pure2-last-use.cpp2"
};
...
#line 339 "regression-tests/pure2-last-use.cpp2"
  public: [[nodiscard]] auto F() && -> decltype(auto);
...
#line 340 "regression-tests/pure2-last-use.cpp2"
};
...
#line 347 "regression-tests/pure2-last-use.cpp2"
};
class issue_857_9: public issue_857_8 {

#line 351 "regression-tests/pure2-last-use.cpp2"
...
#line 366 "regression-tests/pure2-last-use.cpp2"
...
#line 367 "regression-tests/pure2-last-use.cpp2"
};
class issue_869_1 {
...
#line 370 "regression-tests/pure2-last-use.cpp2"
};

using issue_869_2_ret = issue_869_1;
[[nodiscard]] auto issue_869_2() -> issue_869_2_ret;

#line 373 "regression-tests/pure2-last-use.cpp2"
auto issue_884() -> void;

#line 770 "regression-tests/pure2-last-use.cpp2"
auto issue_888_0(std::string r, int size) -> void;

#line 773 "regression-tests/pure2-last-use.cpp2"
...
#line 777 "regression-tests/pure2-last-use.cpp2"
auto issue_890() -> void;

#line 783 "regression-tests/pure2-last-use.cpp2"
auto issue_962(cpp2::impl::in<::std::string> s) -> void;

#line 788 "regression-tests/pure2-last-use.cpp2"
auto draw() -> void;

#line 794 "regression-tests/pure2-last-use.cpp2"
auto enum_0() -> void;

#line 799 "regression-tests/pure2-last-use.cpp2"
auto enum_1() -> void;

#line 828 "regression-tests/pure2-last-use.cpp2"
auto enum_2() -> void;
...
#line 844 "regression-tests/pure2-last-use.cpp2"
};
...
#line 917 "regression-tests/pure2-last-use.cpp2"
...
#line 932 "regression-tests/pure2-last-use.cpp2"
};
...
#line 980 "regression-tests/pure2-last-use.cpp2"
//   f: (move this) = _ = :() x$*;
//   g: (move this) = {
//     for (:() x$*)
//     do (_)
//     { }
//   }
#line 986 "regression-tests/pure2-last-use.cpp2"
};

auto skip_hidden_names() -> void;

#line 1038 "regression-tests/pure2-last-use.cpp2"
...
#line 75 "regression-tests/pure2-last-use.cpp2"
auto issue_350() -> void{
    auto x {21}; 
...
#line 105 "regression-tests/pure2-last-use.cpp2"
auto issue_683(auto const& args) -> void{
...
#line 127 "regression-tests/pure2-last-use.cpp2"
auto issue_847_4(std::vector<int> v) -> void{
  for ( 
...
#line 145 "regression-tests/pure2-last-use.cpp2"
auto issue_847_5(auto&& v) -> void{
  for ( 
...
#line 158 "regression-tests/pure2-last-use.cpp2"
auto issue_850() -> void{
...
#line 172 "regression-tests/pure2-last-use.cpp2"
  issue_857::issue_857(issue_857&& that) noexcept
                                       : a{ std::move(that).a }
                                       , b{ std::move(that).b }{}

#line 181 "regression-tests/pure2-last-use.cpp2"
...
requires (std::is_convertible_v<CPP2_TYPEOF(a_), std::add_const_t<std::unique_ptr<int>>&>) {
                                                                            a = CPP2_FORWARD(a_);
                                                                            return *this;}
#line 261 "regression-tests/pure2-last-use.cpp2"
int gi {0}; 

#line 264 "regression-tests/pure2-last-use.cpp2"
...
#line 267 "regression-tests/pure2-last-use.cpp2"
...
#line 332 "regression-tests/pure2-last-use.cpp2"
...
#line 346 "regression-tests/pure2-last-use.cpp2"
...
#line 371 "regression-tests/pure2-last-use.cpp2"
[[nodiscard]] auto issue_869_2() -> issue_869_2_ret{
                                               issue_869_1 res {}; CPP2_UFCS(set_i)(res, cpp2_new<int>(0));
#line 372 "regression-tests/pure2-last-use.cpp2"
return res; }
#line 373 "regression-tests/pure2-last-use.cpp2"
auto issue_884() -> void{
...
#line 839 "regression-tests/pure2-last-use.cpp2"
  auto cpp2_union::destroy() & -> void{}
#line 840 "regression-tests/pure2-last-use.cpp2"
...
#line 852 "regression-tests/pure2-last-use.cpp2"
return ret; }
#line 853 "regression-tests/pure2-last-use.cpp2"
auto deferred_non_copyable_0() -> void{
...
[[nodiscard]] auto deferred_non_copyable_2() -> deferred_non_copyable_2_ret{
      cpp2::impl::deferred_init<std::unique_ptr<int>> p;
#line 866 "regression-tests/pure2-last-use.cpp2"
  p.construct();
...
#line 909 "regression-tests/pure2-last-use.cpp2"
auto f() -> void{
  auto x {cpp2_new<int>(0)}; 
  f_copy(std::move(cpp2::move(x)));
...
#line 921 "regression-tests/pure2-last-use.cpp2"
...
requires (std::is_convertible_v<CPP2_TYPEOF(x_), std::add_const_t<std::unique_ptr<int>>&>) {
                                                                            x = CPP2_FORWARD(x_);
                                                                            return *this;}
#line 934 "regression-tests/pure2-last-use.cpp2"
auto g() -> void{
  static_cast<void>([]() -> void{
    auto x {cpp2_new<int>(0)}; 
    f_copy(std::move(cpp2::move(x)));
...
#line 950 "regression-tests/pure2-last-use.cpp2"
auto loops_and_captures() -> void{
  static_cast<void>([]() -> void{
    auto x {cpp2_new<int>(0)}; 
    f_copy(std::move(cpp2::move(x)));
...
#line 966 "regression-tests/pure2-last-use.cpp2"
...
requires (std::is_convertible_v<CPP2_TYPEOF(x_), std::add_const_t<std::unique_ptr<int>>&>) {
                                                                            x = CPP2_FORWARD(x_);
                                                                            return *this;}
#line 988 "regression-tests/pure2-last-use.cpp2"
auto skip_hidden_names() -> void{
  static_cast<void>([]() -> void{
    auto x {cpp2_new<int>(0)}; 
    f_copy(std::move(cpp2::move(x)));
...
#line 993 "regression-tests/pure2-last-use.cpp2"
      f_copy(std::move(cpp2::move(x)));
}
#line 994 "regression-tests/pure2-last-use.cpp2"
  });
...
#line 1014 "regression-tests/pure2-last-use.cpp2"
      f_copy(std::move(cpp2::move(x)));
}
#line 1015 "regression-tests/pure2-last-use.cpp2"
  });
...
#line 1039 "regression-tests/pure2-last-use.cpp2"
  issue_683(args);

...
#line 1 "regression-tests/pure2-requires-clauses.cpp2"

#line 2 "regression-tests/pure2-requires-clauses.cpp2"
...
#line 8 "regression-tests/pure2-requires-clauses.cpp2"
};
...
#line 10 "regression-tests/pure2-requires-clauses.cpp2"
;

#line 18 "regression-tests/pure2-requires-clauses.cpp2"
[[nodiscard]] constexpr auto f(auto const& x) -> int
CPP2_REQUIRES (true) ;

#line 20 "regression-tests/pure2-requires-clauses.cpp2"
template<typename T> 
CPP2_REQUIRES_ (std::same_as<T,cpp2::i32>) extern T const v;

#line 22 "regression-tests/pure2-requires-clauses.cpp2"
auto main() -> int;
...
#line 7 "regression-tests/pure2-requires-clauses.cpp2"
...
#line 14 "regression-tests/pure2-requires-clauses.cpp2"
{

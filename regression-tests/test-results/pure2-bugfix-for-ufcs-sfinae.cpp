...
#line 1 "pure2-bugfix-for-ufcs-sfinae.cpp2"
template<typename T> [[nodiscard]] auto f() -> decltype(CPP2_UFCS_NONLOCAL(a)(T()));
...
#line 1 "pure2-bugfix-for-ufcs-sfinae.cpp2"
template<typename T> [[nodiscard]] auto f() -> decltype(CPP2_UFCS_NONLOCAL(a)(T())){}// Fails on Clang 12 (lambda in unevaluated context).

#line 5 "pure2-bugfix-for-ufcs-sfinae.cpp2"
auto main() -> int{
  auto g {[]<typename T>([[maybe_unused]] T const& unnamed_param_1) mutable -> decltype(f<T>()){}}; 

...
#line 748 "pure2-last-use.cpp2"
auto issue_888_0(std::string r, int size) -> void;

#line 751 "pure2-last-use.cpp2"
auto issue_888_1([[maybe_unused]] std::string unnamed_param_1, move_only_function<int(int)> size) -> void;

#line 755 "pure2-last-use.cpp2"
auto draw() -> void;

#line 761 "pure2-last-use.cpp2"
auto enum_0() -> void;

#line 766 "pure2-last-use.cpp2"
auto enum_1() -> void;
...
#line 952 "pure2-last-use.cpp2"
};

auto skip_hidden_names() -> void;

#line 1004 "pure2-last-use.cpp2"
...
auto issue_313() -> void{
  ...
  });
  {
    ...
    *cpp2::assert_not_null(identity(a)) = *cpp2::assert_not_null(identity(a));
    ...
    auto b {cpp2_new<int>(0)}; 
    int auto_32_5 {*cpp2::assert_not_null(identity(b)) = *cpp2::assert_not_null(identity(b))}; 
...
#line 959 "pure2-last-use.cpp2"
      f_copy(std::move(x));
}
#line 960 "pure2-last-use.cpp2"
  });

...
[[nodiscard]] auto main() -> int{
    ...
    std::cout << std::string("inspected vec : " + cpp2::to_string(fun(vec))) << std::endl;
    std::cout << std::string("inspected arr : " + cpp2::to_string(fun(arr))) << std::endl;
    std::cout << std::string("inspected var : " + cpp2::to_string(fun(var))) << std::endl;
    std::cout << std::string("inspected myt : " + cpp2::to_string(fun(myt))) << std::endl;

    std::cout << std::string("inspected vec : " + cpp2::to_string(fun2(std::move(vec)))) << std::endl;
    std::cout << std::string("inspected arr : " + cpp2::to_string(fun2(std::move(arr)))) << std::endl;
    std::cout << std::string("inspected var : " + cpp2::to_string(fun2(std::move(var)))) << std::endl;
    std::cout << std::string("inspected myt : " + cpp2::to_string(fun2(std::move(myt)))) << std::endl;
}

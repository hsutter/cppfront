...
auto main() -> int{
    std::cout << std::string("f1: " + cpp2::to_string(f1(1, 1)) + "\n");
    std::cout << std::string("f2: " + cpp2::to_string(f2(2, 2)) + "\n");
    std::cout << std::string("f3: " + cpp2::to_string(f3<3,3>()) + "\n");
    std::cout << std::string("f4: " + cpp2::to_string(f4<4,4>()) + "\n");
}

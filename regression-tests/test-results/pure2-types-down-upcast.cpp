...
auto func_mut(A& a) -> void     {std::cout << std::string("Call A mut: " + cpp2::to_string(a.i)) << std::endl;}
auto func_mut(B& b) -> void     {std::cout << std::string("Call B mut: " + cpp2::to_string(b.d)) << std::endl;}
auto func_const(cpp2::in<A> a) -> void{std::cout << std::string("Call A const: " + cpp2::to_string(a.i)) << std::endl;}
auto func_const(cpp2::in<B> b) -> void{std::cout << std::string("Call B const: " + cpp2::to_string(b.d)) << std::endl;}

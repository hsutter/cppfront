...
auto main() -> int{
    ...
    std::cout << std::string("x.to_string() is " + cpp2::to_string(CPP2_UFCS(to_string)(x)) + "\n");
    std::cout << std::string("x2.to_string() is " + cpp2::to_string(CPP2_UFCS(to_string)(std::move(x2))) + "\n");
    ...
    std::cout << std::string("file_attributes::cached.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(file_attributes::cached)) + "\n");
    std::cout << std::string("file_attributes::current.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(file_attributes::current)) + "\n");
    std::cout << std::string("file_attributes::obsolete.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(file_attributes::obsolete)) + "\n");
    std::cout << std::string("file_attributes::cached_and_current.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(file_attributes::cached_and_current)) + "\n");

    file_attributes f {file_attributes::cached_and_current}; 
    f &= file_attributes::cached | file_attributes::obsolete;
    std::cout << std::string("f. get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(f)) + "\n");

    auto f2 {file_attributes::cached}; 
    std::cout << std::string("f2.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(f2)) + "\n");
    ...
    std::cout << std::string("f  is (f2) is " + cpp2::to_string(cpp2::is(f, (f2))) + "\n");
    std::cout << std::string("f2 is (f ) is " + cpp2::to_string(cpp2::is(f2, (f))) + "\n\n");
    ...
    std::cout << std::string("f. get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(f)) + "\n");
    std::cout << std::string("f2.get_raw_value() is " + cpp2::to_string(CPP2_UFCS(get_raw_value)(f2)) + "\n");
    std::cout << std::string("f  == f2   is " + cpp2::to_string(f  == f2  ) + "\n");
    std::cout << std::string("f  is (f2) is " + cpp2::to_string(cpp2::is(f, (f2))) + "\n");
    std::cout << std::string("f2 is (f ) is " + cpp2::to_string(cpp2::is(f2, (f))) + "\n");
    std::cout << std::string("(f & f2) == f2 is " + cpp2::to_string((f & f2) == f2) + "\n");

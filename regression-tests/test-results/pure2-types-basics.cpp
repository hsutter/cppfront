...
#line 30 "pure2-types-basics.cpp2"
    ...
    auto myclass::print() const& -> void{
        std::cout << std::string("    data: " + cpp2::to_string(data) + ", more: " + cpp2::to_string(more) + "\n");
    }

    auto myclass::print() && -> void{
        std::cout << std::string("    (move print) data: " + cpp2::to_string(data) + ", more: " + cpp2::to_string(more) + "\n");
    }
    ...
    auto myclass::f(cpp2::in<int> x) const& -> void{
        std::cout << std::string("N::myclass::f with " + cpp2::to_string(x) + "\n");
    }
...
auto main() -> int{
    ...
    CPP2_UFCS(f)(x, 53);
    N::myclass::nested::g();
    std::cout << std::string("f1: " + cpp2::to_string(CPP2_UFCS(f1)(x, 1, 1)) + "\n");
    std::cout << std::string("f2: " + cpp2::to_string(CPP2_UFCS(f2)(x, 2, 2)) + "\n");
    std::cout << std::string("f3: " + cpp2::to_string(CPP2_UFCS_TEMPLATE(f3<3,3>)(x)) + "\n");
    std::cout << std::string("f4: " + cpp2::to_string(CPP2_UFCS_TEMPLATE(f4<4,4>)(x)) + "\n");

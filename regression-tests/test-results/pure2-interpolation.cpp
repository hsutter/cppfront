...
#line 11 "pure2-interpolation.cpp2"
    {
        std::cout << std::string("g" + cpp2::to_string(x) + "g" + cpp2::to_string(x) + "g")  << "\n";
        std::cout << std::string(cpp2::to_string(x) + "g" + cpp2::to_string(x) + "g")   << "\n";
        std::cout << std::string(cpp2::to_string(x) + "g" + cpp2::to_string(x))    << "\n";
        std::cout << std::string(cpp2::to_string(x) + cpp2::to_string(x))     << "\n";
        std::cout << std::string("\"" + cpp2::to_string(x) + "\"")     << "\n";
        std::cout << std::string("\"" + cpp2::to_string(x))       << "\n";
        std::cout << "\""           << "\n";
        std::cout << ""             << "\n";
        std::cout << "pl(ug$h"      << "\n";
        std::cout << std::string(cpp2::to_string(x) + "pl(ug$h")  << "\n";
...
#line 25 "pure2-interpolation.cpp2"
    {
        ...
        std::cout << std::string(cpp2::to_string(CPP2_UFCS(name)(x), "{:20}") + " color " + cpp2::to_string(CPP2_UFCS(color)(x), "{:10}") + " price " + cpp2::to_string(CPP2_UFCS(price)(x), "{: <10.2f}") + " in stock = " + cpp2::to_string(cpp2::cmp_greater(CPP2_UFCS(count)(x),0)) + "\n");
    }
}

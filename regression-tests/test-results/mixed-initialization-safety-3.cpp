...
{
    if (cpp2::Default.has_handler() && !(cpp2::cmp_greater_eq(CPP2_UFCS(ssize)(value),count)) ) { cpp2::Default.report_violation(CPP2_CONTRACT_MSG("fill: value must contain at least count elements")); }

...
auto print_decorated(auto const& x) noexcept -> void;
#line 28 "mixed-initialization-safety-3.cpp2"
[[nodiscard]] auto flip_a_coin() noexcept -> bool;
...
auto print_decorated(auto const& x) noexcept -> void { std::cout<<">> ["<<x<<"]\n"; }

[[nodiscard]] auto flip_a_coin() noexcept -> bool { return std::time(nullptr)%2==0; }
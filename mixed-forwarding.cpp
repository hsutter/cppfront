...
#line 1 "regression-tests/mixed-forwarding.cpp2"


//=== Cpp2 type definitions and function declarations ===========================

#line 1 "regression-tests/mixed-forwarding.cpp2"
#line 3 "regression-tests/mixed-forwarding.cpp2"
...
#line 11 "regression-tests/mixed-forwarding.cpp2"
...
#line 20 "regression-tests/mixed-forwarding.cpp2"
auto apply_explicit_forward(auto&& t) -> void
CPP2_REQUIRES (std::is_convertible_v<CPP2_TYPEOF(t), std::add_const_t<std::pair<X,X>>&>) ;

#line 25 "regression-tests/mixed-forwarding.cpp2"
...
#line 13 "regression-tests/mixed-forwarding.cpp2"
auto use([[maybe_unused]] auto const& unnamed_param_1) -> void{}

#line 16 "regression-tests/mixed-forwarding.cpp2"
auto apply_implicit_forward(auto&& t) -> void
requires (std::is_convertible_v<CPP2_TYPEOF(t), std::add_const_t<std::pair<X,X>>&>) {
#line 17 "regression-tests/mixed-forwarding.cpp2"
...
auto apply_explicit_forward(auto&& t) -> void
requires (std::is_convertible_v<CPP2_TYPEOF(t), std::add_const_t<std::pair<X,X>>&>) {
#line 21 "regression-tests/mixed-forwarding.cpp2"

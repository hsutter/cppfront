...
#line 1 "regression-tests/pure2-type-and-namespace-aliases.cpp2"

#line 2 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
namespace N {

}

#line 8 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
class myclass;
    

#line 25 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
...
#line 14 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
...
#line 28 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
...
#line 17 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
auto myfunc() -> void{
    N1::pmr_vec<myclass::str> v {"xyzzy", "plugh"}; 
{
auto const& v2{cpp2::move(v)};

#line 21 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
    for ( auto const& s : v2 ) 
        std::cout << "" + cpp2::to_string(s) + "\n";
}
#line 23 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
}

#line 26 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
    template <typename T> inline CPP2_CONSTEXPR int myclass2<T>::value{ 42 };

#line 29 "regression-tests/pure2-type-and-namespace-aliases.cpp2"
auto main() -> int{

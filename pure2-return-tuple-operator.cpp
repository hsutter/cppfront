...
#line 1 "regression-tests/pure2-return-tuple-operator.cpp2"

#line 2 "regression-tests/pure2-return-tuple-operator.cpp2"
class A;
...
#line 18 "regression-tests/pure2-return-tuple-operator.cpp2"
};

#line 21 "regression-tests/pure2-return-tuple-operator.cpp2"
auto main() -> int;
...
#line 4 "regression-tests/pure2-return-tuple-operator.cpp2"
        x.construct(12);
        y.construct(34);
...
#line 8 "regression-tests/pure2-return-tuple-operator.cpp2"
    [[nodiscard]] auto A::operator*() const& -> operator_dereference_ret{
            cpp2::impl::deferred_init<int> x;
            cpp2::impl::deferred_init<int> y;
#line 9 "regression-tests/pure2-return-tuple-operator.cpp2"
        x.construct(23);
        y.construct(45);
        return  { std::move(x.value()), std::move(y.value()) }; 
    }
#line 13 "regression-tests/pure2-return-tuple-operator.cpp2"
    [[nodiscard]] auto A::operator[](cpp2::impl::in<int> idx) const& -> operator_subscript_ret{
            cpp2::impl::deferred_init<int> x;
            cpp2::impl::deferred_init<int> y;
#line 14 "regression-tests/pure2-return-tuple-operator.cpp2"

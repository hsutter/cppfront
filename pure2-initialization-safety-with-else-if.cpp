...
#line 1 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"

#line 27 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
class ad_test;
...
#line 28 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
...
#line 34 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
};
...
#line 2 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
...
#line 29 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
...
#line 36 "regression-tests/pure2-initialization-safety-with-else-if.cpp2"
auto ok() -> void{

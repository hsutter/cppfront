...
#line 1 "regression-tests/pure2-default-arguments.cpp2"

#line 30 "regression-tests/pure2-default-arguments.cpp2"
...
#line 32 "regression-tests/pure2-default-arguments.cpp2"
};
template <typename T = int, int N  = 42> auto myfunc(cpp2::impl::in<int> M = 43) -> void;

#line 38 "regression-tests/pure2-default-arguments.cpp2"
...
#line 14 "regression-tests/pure2-default-arguments.cpp2"
template
    <
        typename AssocContainer, 
        typename Func
...
#line 31 "regression-tests/pure2-default-arguments.cpp2"
...
#line 33 "regression-tests/pure2-default-arguments.cpp2"
...
#line 39 "regression-tests/pure2-default-arguments.cpp2"
    my_function_name();
    f();
    f(1);
    f(2);

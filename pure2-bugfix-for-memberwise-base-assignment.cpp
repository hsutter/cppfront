...
#line 1 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
class Base;
#line 2 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
  

#line 7 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
class Derived;
...
#line 3 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
...
#line 4 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
...
#line 10 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
...
#line 9 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
  Derived::Derived()
                            : Base{  }{}
#line 10 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
...
#line 11 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
  auto Derived::operator=(Derived&& that) noexcept -> Derived& {
                                         Base::operator= ( static_cast<Base&&>(that) );
                                         return *this; }

#line 14 "regression-tests/pure2-bugfix-for-memberwise-base-assignment.cpp2"
auto main() -> int{
  auto d {Derived()}; 
  auto d2 {d}; 
  d2 = cpp2::move(d);

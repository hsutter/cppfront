...
#line 1 "regression-tests/mixed-fixed-type-aliases.cpp2"

#line 15 "regression-tests/mixed-fixed-type-aliases.cpp2"
...
#line 1 "regression-tests/mixed-fixed-type-aliases.cpp2"
#line 4 "regression-tests/mixed-fixed-type-aliases.cpp2"

namespace my {
    using u16 = float;
}

#line 9 "regression-tests/mixed-fixed-type-aliases.cpp2"
...
#line 16 "regression-tests/mixed-fixed-type-aliases.cpp2"
    template <typename T> template<typename U> inline CPP2_CONSTEXPR bool mytype<T>::myvalue{ true };

#line 19 "regression-tests/mixed-fixed-type-aliases.cpp2"
[[nodiscard]] auto main(int const argc_, char** argv_) -> int{
    auto const args = cpp2::make_args(argc_, argv_); 
#line 20 "regression-tests/mixed-fixed-type-aliases.cpp2"
    my::u16 y {42}; 
    test(cpp2::move(y));

...
This my own personal set of experiments, not a direction of my employer or of the ISO C++ committee, with the aim that if anything comes of it then I'll bring those results to ISO C++ as proposals. I've already been doing that: Since doing most of the language work on this in 2015-16, every evolution proposal paper I've brought to ISO C++, and every conference talk I've given, has come from this work... only until now I've shown them as standalone C++ evolution proposals under today's syntax.

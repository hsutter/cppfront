...
#line 1 "regression-tests/pure2-type-safety-1.cpp2"

#line 39 "regression-tests/pure2-type-safety-1.cpp2"
class B;
class D;
...
#line 2 "regression-tests/pure2-type-safety-1.cpp2"
[[nodiscard]] auto main() -> int;

#line 32 "regression-tests/pure2-type-safety-1.cpp2"
...
#line 40 "regression-tests/pure2-type-safety-1.cpp2"
class D: public B {
      public: D() = default;
      public: D(D const&) = delete; /* No 'that' constructor, suppress copy */
      public: auto operator=(D const&) -> void = delete;
};
#line 41 "regression-tests/pure2-type-safety-1.cpp2"

auto test_1365(auto const& o) -> void;

#line 63 "regression-tests/pure2-type-safety-1.cpp2"
auto print(cpp2::impl::in<std::string> msg, cpp2::impl::in<bool> b) -> void;
#line 69 "regression-tests/pure2-type-safety-1.cpp2"
...
#line 42 "regression-tests/pure2-type-safety-1.cpp2"
auto test_1365(auto const& o) -> void{

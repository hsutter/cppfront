...
#line 1 "regression-tests/pure2-trailing-commas.cpp2"

#line 9 "regression-tests/pure2-trailing-commas.cpp2"
class vals;
...
#line 6 "regression-tests/pure2-trailing-commas.cpp2"
    i.construct(a * 2);
...
requires (std::is_convertible_v<CPP2_TYPEOF(i_), std::add_const_t<int>&>) {
                                                           i = CPP2_FORWARD(i_);
                                                           return *this;}
#line 11 "regression-tests/pure2-trailing-commas.cpp2"
auto main() -> int{
{
auto a{42};
#line 12 "regression-tests/pure2-trailing-commas.cpp2"
    while( false ) {++a; }
}
#line 13 "regression-tests/pure2-trailing-commas.cpp2"

...
#line 1 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
class identity;
#line 2 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
  

#line 5 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
class t;
  

#line 9 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
class u;
...
#line 6 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
  [[nodiscard]] constexpr auto t::f() const& -> int { return 0;  }

#line 11 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
namespace ns {
#line 12 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
[[nodiscard]] constexpr auto f([[maybe_unused]] auto const& unnamed_param_1) -> int { return 1;  }
}

#line 20 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
auto main() -> int{
  {
    int f {CPP2_UFCS(f)(t())}; 
...
{
auto const& f{t().f()};
#line 33 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
  if (cpp2::cpp2_default.is_active() && !(f == 0) ) { cpp2::cpp2_default.report_violation(""); }
}
{
auto const& f{t().f()};
#line 34 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
  if (cpp2::cpp2_default.is_active() && !(f == 0) ) { cpp2::cpp2_default.report_violation(""); }
}
#line 35 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
  {
...
#line 59 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
      if (cpp2::cpp2_default.is_active() && !(CPP2_UFCS(f)(t()) == 0) ) { cpp2::cpp2_default.report_violation(""); }
}
{
cpp2::impl::in<identity> f{identity()};
#line 60 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
      static_cast<void>(CPP2_UFCS(f)(u()));
}
#line 61 "regression-tests/pure2-bugfix-for-ufcs-name-lookup.cpp2"
    }}; 
    static_cast<void>(cpp2::move(f));
  }
  {

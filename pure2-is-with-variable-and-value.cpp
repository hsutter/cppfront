...
#line 1 "regression-tests/pure2-is-with-variable-and-value.cpp2"

#line 26 "regression-tests/pure2-is-with-variable-and-value.cpp2"
class WithOp;
    

#line 30 "regression-tests/pure2-is-with-variable-and-value.cpp2"
class WithGenOp;
    

#line 39 "regression-tests/pure2-is-with-variable-and-value.cpp2"
class Cmp;
...
#line 14 "regression-tests/pure2-is-with-variable-and-value.cpp2"
...
#line 28 "regression-tests/pure2-is-with-variable-and-value.cpp2"
};
...
#line 37 "regression-tests/pure2-is-with-variable-and-value.cpp2"
};
...
#line 41 "regression-tests/pure2-is-with-variable-and-value.cpp2"
};
...
#line 1 "regression-tests/pure2-is-with-variable-and-value.cpp2"
auto fun(auto const& name, auto const& v) -> void{
#line 2 "regression-tests/pure2-is-with-variable-and-value.cpp2"
    std::cout << name << ": " << 
...
#line 27 "regression-tests/pure2-is-with-variable-and-value.cpp2"
    [[nodiscard]] auto WithOp::op_is(cpp2::impl::in<int> x) const& -> decltype(auto) { return x == 123;  }

#line 31 "regression-tests/pure2-is-with-variable-and-value.cpp2"
...
#line 40 "regression-tests/pure2-is-with-variable-and-value.cpp2"

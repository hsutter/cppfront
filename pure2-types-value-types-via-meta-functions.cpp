...
#line 1 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"

#line 2 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
class widget;
    

#line 7 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
class w_widget;
    

#line 12 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
class p_widget;
...
#line 4 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
...
#line 5 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
};

class w_widget {
    private: int val {0}; 
    public: w_widget(cpp2::impl::in<int> i);
#line 9 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
...
#line 10 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
};

class p_widget {
    private: int val {0}; 
    public: p_widget(cpp2::impl::in<int> i);
#line 14 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
...
#line 15 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
};

auto main() -> int;

#line 23 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
...
auto p_widget::operator=(p_widget&& that) noexcept -> p_widget& {
                                ...
                                return *this;}
p_widget::p_widget(){}
#line 17 "regression-tests/pure2-types-value-types-via-meta-functions.cpp2"
auto main() -> int{
    test<widget>();
    test<w_widget>();
    test<p_widget>();

...
#line 1 "regression-tests/pure2-defaulted-comparisons-and-final-types.cpp2"

#line 2 "regression-tests/pure2-defaulted-comparisons-and-final-types.cpp2"
class widget;
...
#line 6 "regression-tests/pure2-defaulted-comparisons-and-final-types.cpp2"
...
#line 11 "regression-tests/pure2-defaulted-comparisons-and-final-types.cpp2"
};
...
#line 13 "regression-tests/pure2-defaulted-comparisons-and-final-types.cpp2"
auto main() -> int{
    widget a {1}; 
    widget b {2}; 

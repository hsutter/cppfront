...
#line 3987 "reflect.h2"
    ...
    public: autodiff_declaration_stack_item(auto&& full_name_, auto&& decl_)
CPP2_REQUIRES_ (std::is_convertible_v<CPP2_TYPEOF(full_name_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(decl_), std::add_const_t<meta::type_or_namespace_declaration>&>) ;
...
#line 3988 "reflect.h2"
    ...
    autodiff_declaration_stack_item::autodiff_declaration_stack_item(auto&& full_name_, auto&& decl_)
requires (std::is_convertible_v<CPP2_TYPEOF(full_name_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(decl_), std::add_const_t<meta::type_or_namespace_declaration>&>) 
                                                                                                                                : full_name{ CPP2_FORWARD(full_name_) }
                                                                                                                                , decl{ CPP2_FORWARD(decl_) }{}
...
#line 4045 "reflect.h2"
    auto autodiff_context::create_namespace_stack(cpp2::impl::in<meta::type_or_namespace_declaration> t) & -> void{
        ...
        static_cast<void>(CPP2_UFCS(emplace_back)(declaration_stack, autodiff_declaration_stack_item(cpp2::move(full_name), t)));
    }
...
auto autodiff(meta::type_declaration& t) -> void
{
    ...
    CPP2_UFCS(create_namespace_stack)(ad_ctx, t);
    ...
    if ( CPP2_UFCS(is_function)(m)) 
    {
        ...
        if (CPP2_UFCS(has_non_void_return_type)(mf) && CPP2_UFCS(empty)(CPP2_UFCS(get_returns)(mf))) {// TODO: has_non_void_return_type is true for return lists: (r: double) bug/feature?
            ...
            if (CPP2_UFCS(has_deduced_return_type)(mf)) {
                ...
                diff += "r: " + cpp2::to_string(CPP2_UFCS(get_unnamed_return_type)(mf)) + " = (), r" + cpp2::to_string(suffix) + ": " + cpp2::to_string(CPP2_UFCS(get_ad_type)(ad_ctx, CPP2_UFCS(get_unnamed_return_type)(mf))) + " = (), ";
            }
        }
        else {

...
#line 4834 "reflect.h2"
class autodiff_activity_check;
    

#line 4932 "reflect.h2"
...
#line 7093 "reflect.h2"
class generation_context;

#line 7292 "reflect.h2"
class alternative_token;

#line 7307 "reflect.h2"
class alternative_token_gen;

#line 7372 "reflect.h2"
class any_token;

#line 7389 "reflect.h2"
class atomic_group_token;

#line 7419 "reflect.h2"
class char_token;

#line 7534 "reflect.h2"
class class_token;

#line 7758 "reflect.h2"
class group_ref_token;

#line 7895 "reflect.h2"
class group_token;

#line 8242 "reflect.h2"
class lookahead_lookbehind_token;

#line 8337 "reflect.h2"
class range_token;

#line 8494 "reflect.h2"
class special_range_token;

#line 8580 "reflect.h2"
template<typename Error_out> class regex_generator;

#line 8846 "reflect.h2"
}
...
auto euclidean_vector(meta::type_declaration& t) -> void;

#line 1968 "reflect.h2"
auto basic_value(meta::type_declaration& t) -> void;

#line 1996 "reflect.h2"
auto value(meta::type_declaration& t) -> void;

#line 2002 "reflect.h2"
...
#line 5980 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::bit_or_expression> binexpr) -> void override;

#line 5984 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::bit_xor_expression> binexpr) -> void override;

#line 5988 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::bit_and_expression> binexpr) -> void override;

#line 5992 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::equality_expression> binexpr) -> void override;

#line 5996 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::relational_expression> binexpr) -> void override;

#line 6000 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::compare_expression> binexpr) -> void override;

#line 6004 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::shift_expression> binexpr) -> void override;

#line 6008 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::additive_expression> binexpr) -> void override;
...
#line 6020 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::prefix_expression> prefix) -> void override;

#line 6025 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::postfix_expression> postfix) -> void override;

#line 6057 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::primary_expression> primary) -> void override;
...
#line 6270 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::type_declaration> t) -> void override;

#line 6294 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::parameter_declaration> t) -> void override;

#line 6299 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::statement> stmt) -> void override;
...
#line 6474 "reflect.h2"
};

#line 6477 "reflect.h2"
...
#line 6495 "reflect.h2"
};

#line 6498 "reflect.h2"
...
#line 6513 "reflect.h2"
};

#line 6516 "reflect.h2"
//  Represents a list of regex tokens as one token.
//
class regex_token_list
: public regex_token {

#line 6522 "reflect.h2"
...
#line 6626 "reflect.h2"
};

#line 6629 "reflect.h2"
...
#line 7367 "reflect.h2"
};

#line 7370 "reflect.h2"
//  Regex syntax: .
//
class any_token
...
#line 7438 "reflect.h2"
    public: [[nodiscard]] static auto parse(parse_context& ctx) -> token_ptr;

#line 7442 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;

#line 7465 "reflect.h2"
...
#line 7529 "reflect.h2"
};

#line 7532 "reflect.h2"
//  Regex syntax: [<character classes>]  Example: [abcx-y[:digits:]]
//
class class_token
: public regex_token {

#line 7538 "reflect.h2"
    private: bool negate; 
...
#line 7550 "reflect.h2"
    //  TODO: Rework class generation: Generate check functions for classes.
    public: [[nodiscard]] static auto parse(parse_context& ctx) -> token_ptr;

#line 7676 "reflect.h2"
    public: [[nodiscard]] auto reverse() const -> token_ptr override;

#line 7685 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;

#line 7690 "reflect.h2"
...
#line 7697 "reflect.h2"
};

#line 7700 "reflect.h2"
//  Regex syntax: \a or \n or \[
//
...
#line 7774 "reflect.h2"
    public: [[nodiscard]] static auto parse(parse_context& ctx) -> token_ptr;

#line 7875 "reflect.h2"
    public: [[nodiscard]] auto reverse() const -> token_ptr override;

#line 7879 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;
...
#line 8255 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;

#line 8266 "reflect.h2"
    public: [[nodiscard]] auto reverse() const -> token_ptr override;

#line 8273 "reflect.h2"
    public: auto add_groups(std::set<int>& groups) const -> void override;
...
#line 8446 "reflect.h2"
    public: [[nodiscard]] auto gen_range_string() const& -> std::string;

#line 8465 "reflect.h2"
    public: [[nodiscard]] auto reverse() const -> token_ptr override;

#line 8475 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;

#line 8486 "reflect.h2"
    public: auto add_groups(std::set<int>& groups) const -> void override;
...
#line 8489 "reflect.h2"
};

#line 8492 "reflect.h2"
//  Regex syntax: *, +, or ?  Example: aa*
//
class special_range_token
: public range_token {

#line 8498 "reflect.h2"
    public: [[nodiscard]] static auto parse(parse_context& ctx) -> token_ptr;
...
#line 8595 "reflect.h2"
    public: [[nodiscard]] auto parse() & -> std::string;

#line 8630 "reflect.h2"
...
//
//  euclidean_vector
//  (a little metafunction experiment)
//
//  Automatically generate +, -, * and / operators across all member variables, optionally with
//  a single numeric type argument (eg. vector3 * float) if given a template argument. 
//
//  Additionally creates functions For getting the magnitude/length, normalisation, dot product.
//
#line 1799 "reflect.h2"
auto euclidean_vector(meta::type_declaration& t) -> void
{
    auto single_arg_type {CPP2_UFCS(get_argument)(t, 0)}; 
    bool add_single_arg_fns {CPP2_UFCS(size)(single_arg_type) != 0}; 

    std::string op_add {"operator+: (this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_sub {"operator-: (this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_mul {"operator*: (this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_div {"operator/: (this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 

    std::string op_negate {"operator-: (this) -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 

    std::string op_assign_add {"operator+=: (inout this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") = { "}; 
    std::string op_assign_sub {"operator-=: (inout this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") = { "}; 
    std::string op_assign_mul {"operator*=: (inout this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") = { "}; 
    std::string op_assign_div {"operator/=: (inout this, in_ref other: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") = { "}; 

    std::string op_add_sc {"operator+: (this, other: " + cpp2::to_string(single_arg_type) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_sub_sc {"operator-: (this, other: " + cpp2::to_string(single_arg_type) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_mul_sc {"operator*: (this, other: " + cpp2::to_string(single_arg_type) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 
    std::string op_div_sc {"operator/: (this, other: " + cpp2::to_string(single_arg_type) + ") -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = " + cpp2::to_string(CPP2_UFCS(name)(t)) + "( "}; 

    std::string op_assign_add_sc {"operator+=: (inout this, other: " + cpp2::to_string(single_arg_type) + ") = { "}; 
    std::string op_assign_sub_sc {"operator-=: (inout this, other: " + cpp2::to_string(single_arg_type) + ") = { "}; 
    std::string op_assign_mul_sc {"operator*=: (inout this, other: " + cpp2::to_string(single_arg_type) + ") = { "}; 
    std::string op_assign_div_sc {"operator/=: (inout this, other: " + cpp2::to_string(cpp2::move(single_arg_type)) + ") = { "}; 

    std::string fn_lengthSq {"lengthSquared: (this) -> _ = "}; 

    std::string fn_normalise {"normalise: (inout this) = {\n    len: _ = length();\n"}; 
    std::string fn_normalised {"normalised: (this) -> " + cpp2::to_string(CPP2_UFCS(name)(t)) + " = {\n    len: _ = length();\n    return " + cpp2::to_string(CPP2_UFCS(name)(t)) + "(\n"}; 

    std::string fn_dot {"dot: (in_ref lhs: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ", in_ref rhs: " + cpp2::to_string(CPP2_UFCS(name)(t)) + ") -> _ = "}; 

    bool after_first_value_added {false}; 
    for ( 
          auto const& o : CPP2_UFCS(get_member_objects)(t) ) 
    {
        if (after_first_value_added) {
            op_add += ", ";
            op_sub += ", ";
            op_mul += ", ";
            op_div += ", ";
        ...
        op_add += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " + other." + cpp2::to_string(CPP2_UFCS(name)(o)) + "";
        op_sub += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " - other." + cpp2::to_string(CPP2_UFCS(name)(o)) + "";
        op_mul += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " * other." + cpp2::to_string(CPP2_UFCS(name)(o)) + "";
        op_div += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " / other." + cpp2::to_string(CPP2_UFCS(name)(o)) + "";

        op_negate += "-" + cpp2::to_string(CPP2_UFCS(name)(o)) + "";

        fn_normalise += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " /= len;\n";
        fn_normalised += "    " + cpp2::to_string(CPP2_UFCS(name)(o)) + " / len";

        if (add_single_arg_fns) {
            op_add_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " + other";
            op_sub_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " - other";
            op_mul_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " * other";
            op_div_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " / other";
        }

        op_assign_add += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " += other." + cpp2::to_string(CPP2_UFCS(name)(o)) + ";";
        op_assign_sub += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " -= other." + cpp2::to_string(CPP2_UFCS(name)(o)) + ";";
        op_assign_mul += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " *= other." + cpp2::to_string(CPP2_UFCS(name)(o)) + ";";
        op_assign_div += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " /= other." + cpp2::to_string(CPP2_UFCS(name)(o)) + ";";

        if (add_single_arg_fns) {
            op_assign_add_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " += other;";
            op_assign_sub_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " -= other;";
            op_assign_mul_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " *= other;";
            op_assign_div_sc += "" + cpp2::to_string(CPP2_UFCS(name)(o)) + " /= other;";
        }

        fn_lengthSq += "( " + cpp2::to_string(CPP2_UFCS(name)(o)) + " * " + cpp2::to_string(CPP2_UFCS(name)(o)) + " )";
        fn_dot += "( lhs." + cpp2::to_string(CPP2_UFCS(name)(o)) + " * rhs." + cpp2::to_string(CPP2_UFCS(name)(o)) + " )";

        after_first_value_added = true;
    }
    ...
    CPP2_UFCS(add_member)(t, cpp2::move(fn_lengthSq));
    CPP2_UFCS(add_member)(t, "length: (this) -> _ = std::sqrt( lengthSquared() );");

    CPP2_UFCS(add_member)(t, cpp2::move(fn_normalise));
    CPP2_UFCS(add_member)(t, cpp2::move(fn_normalised));

    CPP2_UFCS(add_member)(t, cpp2::move(fn_dot));

    CPP2_UFCS(add_member)(t, cpp2::move(op_add));
    CPP2_UFCS(add_member)(t, cpp2::move(op_sub));
    CPP2_UFCS(add_member)(t, cpp2::move(op_mul));
    CPP2_UFCS(add_member)(t, cpp2::move(op_div));

    CPP2_UFCS(add_member)(t, cpp2::move(op_negate));

    CPP2_UFCS(add_member)(t, cpp2::move(op_assign_add));
    CPP2_UFCS(add_member)(t, cpp2::move(op_assign_sub));
    CPP2_UFCS(add_member)(t, cpp2::move(op_assign_mul));
    CPP2_UFCS(add_member)(t, cpp2::move(op_assign_div));

    if (cpp2::move(add_single_arg_fns)) {
        CPP2_UFCS(add_member)(t, cpp2::move(op_add_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_sub_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_mul_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_div_sc));

        CPP2_UFCS(add_member)(t, cpp2::move(op_assign_add_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_assign_sub_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_assign_mul_sc));
        CPP2_UFCS(add_member)(t, cpp2::move(op_assign_div_sc));
    }
}
...
#line 7543 "reflect.h2"
    {

#line 7548 "reflect.h2"
    }

#line 7551 "reflect.h2"
...
#line 7702 "reflect.h2"
[[nodiscard]] auto escape_token_parse(parse_context& ctx) -> token_ptr
{
    if (ctx.current() != '\\') {return nullptr; }

#line 7707 "reflect.h2"
...
#line 8346 "reflect.h2"
    range_token::range_token()
                             : regex_token{ "" }{}

#line 8348 "reflect.h2"
...

{
         ...
         auto const& meta : n.metafunctions ) 
    {
        ...
        else {if (name == "euclidean_vector") {
            euclidean_vector(rtype);
        }

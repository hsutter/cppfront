...
#line 4804 "reflect.h2"
    public: explicit regex_token();

#line 4809 "reflect.h2"
...
#line 6641 "reflect.h2"
};

#line 6644 "reflect.h2"
...
#line 4007 "reflect.h2"
    [[nodiscard]] auto autodiff_expression_handler::handle_math_func(cpp2::impl::in<std::string> func_name, cpp2::impl::in<std::string> arg) & -> bool{
        ...
        diff += "" + cpp2::to_string(lhs) + "_d = " + cpp2::to_string(cpp2::move(func_diff)) + " * " + cpp2::to_string(arg) + "_d;\n";
...
#line 4066 "reflect.h2"
    auto autodiff_expression_handler::traverse(cpp2::impl::in<meta::additive_expression> binexpr) -> void{
        ...
        auto first {true}; 
        std::string fwd {"" + cpp2::to_string(lhs) + "_d " + cpp2::to_string(declare_p) + "= "}; 
        std::string primal {"" + cpp2::to_string(lhs) + "   " + cpp2::to_string(declare_d) + "= "}; 
        for ( auto const& term : cpp2::move(terms) ) {
            if (!(first)) {
...
#line 4119 "reflect.h2"
            if (i + 1 == CPP2_UFCS(ssize)(terms)) {
                // Last item
                diff += "" + cpp2::to_string(lhs) + "_d " + cpp2::to_string(declare_p) + "= " + cpp2::to_string(cpp2::move(fwd)) + ";";
                diff += "" + cpp2::to_string(lhs) + "   " + cpp2::to_string(declare_d) + "= " + cpp2::to_string(cpp2::move(primal)) + ";";
            }
            else {
                // Temporary
                auto t {CPP2_UFCS(gen_temporary)((*cpp2::impl::assert_not_null(ctx)))}; 
...
#line 4145 "reflect.h2"
    auto autodiff_expression_handler::traverse(cpp2::impl::in<meta::postfix_expression> postfix) -> void
    {
        ...
        diff += "" + cpp2::to_string(lhs) + "   " + cpp2::to_string(declare_p) + "= " + cpp2::to_string(ret_temp) + ".r;\n";
...
#line 4190 "reflect.h2"
    ...
    {
        if (CPP2_UFCS(is_identifier)(primary)) {
            diff += "" + cpp2::to_string(lhs) + "_d " + cpp2::to_string(declare_p) + "= " + cpp2::to_string(CPP2_UFCS(to_string)(primary)) + "_d;";
            diff += "" + cpp2::to_string(lhs) + "   " + cpp2::to_string(declare_d) + "= " + cpp2::to_string(CPP2_UFCS(to_string)(primary)) + ";";
        }
        else {if (CPP2_UFCS(is_expression_list)(primary)) {
            ...
            diff += "" + cpp2::to_string(lhs) + "_d " + cpp2::to_string(declare_p) + "= ();";
            diff += "" + cpp2::to_string(lhs) + "   " + cpp2::to_string(declare_d) + "= " + cpp2::to_string(CPP2_UFCS(to_string)(primary)) + ";";
        }
        else {if (CPP2_UFCS(is_declaration)(primary)) {

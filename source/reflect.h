...
#line 4942 "reflect.h2"
        if (handle_special_function(object, object_d, cpp2::move(object_b), function_name, args)) {
            return ; 
        }
...
#line 7904 "reflect.h2"
    range_token::range_token()
                             : regex_token{ "" }{}

#line 7906 "reflect.h2"

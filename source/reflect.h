...
#line 3742 "reflect.h2"
    ...
    public: autodiff_expression_handler(autodiff_context* ctx_, cpp2::impl::in<std::string> lhs_);
...
#line 3746 "reflect.h2"
    autodiff_expression_handler::autodiff_expression_handler(autodiff_context* ctx_, cpp2::impl::in<std::string> lhs_)
        : simple_traverser{  }
...
#line 3751 "reflect.h2"
    [[nodiscard]] auto autodiff_expression_handler::handle_expression_term(auto const& term) & -> std::string{
        if (CPP2_UFCS(is_identifier)(term)) {
            ...
            autodiff_expression_handler ad {ctx, t}; 
            //ad..traverse(term..get_expression_list());

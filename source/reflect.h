...
#line 4647 "reflect.h2"
    public: class primal_fwd_rws_name {
        ...
        public: primal_fwd_rws_name(auto&& primal_, auto&& fwd_, auto&& rws_)
CPP2_REQUIRES_ (std::is_convertible_v<CPP2_TYPEOF(primal_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(fwd_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(rws_), std::add_const_t<std::string>&>) ;
...
#line 5321 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::bit_and_expression> binexpr) -> void override;

#line 5325 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::equality_expression> binexpr) -> void override;
...
#line 5337 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::shift_expression> binexpr) -> void override;

#line 5341 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::additive_expression> binexpr) -> void override;
...
#line 5358 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::postfix_expression> postfix) -> void override;

#line 5390 "reflect.h2"
    public: auto traverse(cpp2::impl::in<meta::primary_expression> primary) -> void override;
...
#line 6633 "reflect.h2"
    public: auto generate_code(generation_context& ctx) const -> void override;

#line 6650 "reflect.h2"
    public: auto add_groups(std::set<int>& groups) const -> void override;
...
#line 6682 "reflect.h2"
};

#line 6685 "reflect.h2"
//  Regex syntax: .
//
class any_token
...
#line 7804 "reflect.h2"
};

#line 7807 "reflect.h2"
...
#line 4642 "reflect.h2"
    [[nodiscard]] auto autodiff_expression_handler::gen_declaration(cpp2::impl::in<std::string> lhs, cpp2::impl::in<std::string> type) & -> decltype(auto) { 
        ...
        autodiff_expression_handler::primal_fwd_rws_name::primal_fwd_rws_name(auto&& primal_, auto&& fwd_, auto&& rws_)
requires (std::is_convertible_v<CPP2_TYPEOF(primal_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(fwd_), std::add_const_t<std::string>&> && std::is_convertible_v<CPP2_TYPEOF(rws_), std::add_const_t<std::string>&>) 
...
#line 4662 "reflect.h2"
    [[nodiscard]] auto autodiff_expression_handler::handle_expression_term(auto const& term) & -> primal_fwd_rws_name{
        if (CPP2_UFCS(is_identifier)(term)) {
            ...
            return { cpp2::move(primal), cpp2::move(fwd), cpp2::move(rws) }; 
        }
        else {if (CPP2_UFCS(is_expression_list)(term)) {
            ...
            primal_fwd_rws_name r {t, t + (*cpp2::impl::assert_not_null(ctx)).fwd_suffix, t + (*cpp2::impl::assert_not_null(ctx)).rws_suffix}; // TODO: Check why on return (t, t + ctx*.fwd_suffix) the primal is initialized empty. Probably because of the move(t)
...
#line 4967 "reflect.h2"
    auto autodiff_expression_handler::traverse(cpp2::impl::in<meta::multiplicative_expression> binexpr) -> void{
        ...
        for( ; cpp2::impl::cmp_less(i,CPP2_UFCS(ssize)(terms)); i += 1 ) {
            ...
            if ("*" == op) {
                if (CPP2_UFCS(is_taylor)((*cpp2::impl::assert_not_null(ctx)))) {
                    fwd = "" + cpp2::to_string(arg_a_d) + "..mul(" + cpp2::to_string(arg_b_d) + ", " + cpp2::to_string(arg_a) + ", " + cpp2::to_string(arg_b) + ")";
                    rws = "" + cpp2::to_string(cpp2::move(arg_b_b)) + " += " + cpp2::to_string(arg_a_d) + "..mul(_rb_, " + cpp2::to_string(arg_a) + ", _r_);\n"
                          "" + cpp2::to_string(arg_a_b) + " += " + cpp2::to_string(cpp2::move(arg_b_d)) + "..mul(_rb_, " + cpp2::to_string(arg_b) + ", _r_);";
                }
                else {
                    fwd = "" + cpp2::to_string(arg_a) + " * " + cpp2::to_string(cpp2::move(arg_b_d)) + " + " + cpp2::to_string(arg_b) + " * " + cpp2::to_string(arg_a_d) + "";
                    rws = "" + cpp2::to_string(cpp2::move(arg_b_b)) + " += " + cpp2::to_string(arg_a) + " * _rb_;\n"
                          "" + cpp2::to_string(arg_a_b) + " += " + cpp2::to_string(arg_b) + " * _rb_;";
                }
                primal = "" + cpp2::to_string(arg_a) + " * " + cpp2::to_string(cpp2::move(arg_b)) + "";
            }
            else {if ("/" == op) {
                if (CPP2_UFCS(is_taylor)((*cpp2::impl::assert_not_null(ctx)))) {
                    fwd = "" + cpp2::to_string(arg_a_d) + ".div(" + cpp2::to_string(arg_b_d) + ", " + cpp2::to_string(arg_a) + ", " + cpp2::to_string(arg_b) + ")";
                    rws = "" + cpp2::to_string(cpp2::move(arg_b_b)) + " -= " + cpp2::to_string(arg_a_d) + ".mul(_rb_, " + cpp2::to_string(arg_a) + ", _r_).div(" + cpp2::to_string(arg_b_d) + ".mul(" + cpp2::to_string(arg_b_d) + ", " + cpp2::to_string(arg_b) + ", " + cpp2::to_string(arg_b) + "), " + cpp2::to_string(arg_a) + " * _r_, " + cpp2::to_string(arg_b) + " * " + cpp2::to_string(arg_b) + ");\n"
                          "" + cpp2::to_string(arg_a_b) + " += _rb_.div(" + cpp2::to_string(arg_b_d) + ", _r_, " + cpp2::to_string(arg_b) + ");";
                }
                else {
                    ...
                    rws = "" + cpp2::to_string(cpp2::move(arg_b_b)) + " -= " + cpp2::to_string(arg_a) + " * _rb_ / (" + cpp2::to_string(arg_b) + " * " + cpp2::to_string(arg_b) + ");\n"
                          "" + cpp2::to_string(arg_a_b) + " += _rb_ / " + cpp2::to_string(arg_b) + ";";
                }
                primal = "" + cpp2::to_string(arg_a) + " / " + cpp2::to_string(cpp2::move(arg_b)) + "";
            }
            else {
...
#line 5019 "reflect.h2"
            if (i + 1 == CPP2_UFCS(ssize)(terms)) {
                ...
                auto t_b {t + (*cpp2::impl::assert_not_null(ctx)).rws_suffix}; 
                gen_declaration(t, t_d, t_b, cpp2::move(primal), cpp2::move(fwd), cpp2::move(rws), "", "", "");

                arg_a   = cpp2::move(t);
                arg_a_d = cpp2::move(t_d);
                arg_a_b = cpp2::move(t_b);
            }
        }
    }
...
#line 6858 "reflect.h2"
    {

#line 6863 "reflect.h2"
    }
...
#line 7017 "reflect.h2"
[[nodiscard]] auto escape_token_parse(parse_context& ctx) -> token_ptr
{
    if (ctx.current() != '\\') {return nullptr; }

#line 7022 "reflect.h2"
...
#line 7082 "reflect.h2"
    {

#line 7087 "reflect.h2"
    }
...
#line 7661 "reflect.h2"
    range_token::range_token()
                             : regex_token{ "" }{}

#line 7663 "reflect.h2"

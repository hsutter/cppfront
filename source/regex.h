...
#line 119 "regex.h2"
    ...
    template <typename CharT, typename Matcher, size_t groups> [[nodiscard]] auto regular_expression<CharT,Matcher,groups>::search(cpp2::in<view<CharT>> str, context& ctx) const& -> bool { return search(str, 0, ctx);  }

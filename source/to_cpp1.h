...
#include "to_cpp1_helpers/positional_printer.h"
#include "to_cpp1_helpers/utility_functions.h"
...
public:
        ...
        , sema      { errors }
    {
        ...
        //
        source_loaded = cpp2::check_sourcefile_extension(sourcefile, errors) 
                     && cpp2::load_sourcefile(sourcefile, source, errors);
